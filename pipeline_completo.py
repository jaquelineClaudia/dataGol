...
def read_csv_auto(path):
    """Lee CSV intentando codificaciones comunes en Windows/Excel."""
    # Caso comun: archivo .csv que en realidad es un .xlsx renombrado.
    ...
    for enc in ("utf-8", "utf-8-sig", "latin-1", "cp1252"):
        try:
            ...
            # Reintento flexible cuando hay separadores/campos inconsistentes.
...
# Soporta tanto esquema antiguo (country_full/rank_date) como el actual (pais/fecha_publicacion).
